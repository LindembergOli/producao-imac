...
const FrontSectorEnum = z.enum([
    ...
    'CONFEITARIA', 'PÃES', 'PAES', 'SALGADO', 'PÃO DE QUEIJO', 'PAO_DE_QUEIJO', 'PAO DE QUEIJO', 'EMBALADORA', 'MANUTENÇÃO', 'MANUTENCAO'
]);
...
export const createSchema = z.object({
    ...
    unit: UnitEnum,
    unitCost: z.number().nonnegative(), // Custo por KG (obrigatório)
