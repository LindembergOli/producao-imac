...
router.post('/', validate(validator.createSchema), canAccessCadastro, auditFieldsMiddleware, controller.create, auditCreate('Product'));
router.put('/:id', validate(validator.idParamSchema, 'params'), validate(validator.updateSchema), canAccessCadastro, auditFieldsMiddleware, controller.update, auditUpdate('Product'));
